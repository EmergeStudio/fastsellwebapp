$(document).ready(function(){
    ...
    {
        // On click
        $('.checkDataContainer .coolTable.customers td').live('click', function()
        {
            // Some variables
            $this               = $(this);
            $value              = $this.html();
        ...
        // On blur
        $('.checkDataContainer .coolTable.customers td input').live('blur', function()
        {
            // Some variables
            $this               = $(this);
        ...
        {
            // Remove the row
            $(this).parents('.contain_customer').remove();
